...
class Ctl_Rzps_Weixin extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function config()
    {
        ...
        $this->tmpl = 'rzps/weixin/config.html';
    }
    ...
    public function welcome()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/weixin/welcome.html';
        }
    }
    ...
    public function leaflets()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/weixin/leaflets.html';
        }
    }
}