...
class Ctl_Rzps_Shop extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'rzps/shop/index.html';
    }
    ...
    public function domain()
    {
        ...
        if (! $CFG['domain']['shop']) {
            ...
            if ($domain = $this->checksubmit('domain')) {
                ...
                $this->tmpl = 'rzps/shop/domain.html';
            }
    }
    ...
    public function refresh()
    {
        ...
        if ($this->GP('fromid')) {
            ...
            $this->tmpl = 'rzps/shop/refresh/look.html';
        }
    }
