...
class Ctl_Rzps_Shop_Coupon extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'rzps/shop/coupon/items.html';
    }
                ...
                if ($allow_coupon < 0) {
                    ...
                    if (! $data = $this->check_fields($data, $this->_allow_fields)) {
                        ...
                        if ($coupon_id = K::M('shop/coupon')->create($data)) {
                            ...
                            $this->err->set_data('forward', $this->mklink('rzps/shop/coupon:index'));
                        }
                    }
            } else {
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'rzps/shop/coupon/create.html';
            }
    }
            ...
            if (! $detail = K::M('shop/coupon')->detail($coupon_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'rzps/shop/coupon/edit.html';
                    }
    }
    ...
    public function downloads($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/shop/coupon/downloads.html';
    }
        ...
        if (! $download_id = (int) $download_id) {
            ...
            if (! $detail = K::M('shop/couponDownload')->detail($download_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'rzps/shop/coupon/downloadDetail.html';
                }
    }
