...
class Ctl_Rzps_Shop_Vcate extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'rzps/shop/vcate/items.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/shop/vcate/create.html';
        }
    }
            ...
            if (! $detail = K::M('shop/vcate')->detail($vcat_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'rzps/shop/vcate/edit.html';
                    }
    }
