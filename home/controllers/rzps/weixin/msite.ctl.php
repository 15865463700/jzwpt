...
class Ctl_Rzps_Weixin_Msite extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    {
        $this->tmpl = 'rzps/weixin/msite/access.html';
    }
    ...
    public function index()
    {
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/weixin/msite/index.html';
        }
    }
    ...
    public function tmpl($from = 'index')
    {
        ...
        if ($tmpl = $this->checksubmit('template')) {
            ...
            $this->tmpl = 'rzps/weixin/msite/tmpl.html';
        }
    }
