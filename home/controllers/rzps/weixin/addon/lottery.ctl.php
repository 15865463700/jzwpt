...
class Ctl_Rzps_Weixin_Addon_Lottery extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'rzps/weixin/addon/lottery/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/weixin/addon/lottery/create.html';
        }
    }
        ...
        if (! ($lottery_id = (int) $lottery_id) && ! ($lottery_id = $this->GP('lottery_id'))) {
            ...
            if (! $detail = K::M('weixin/lottery')->detail($lottery_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'rzps/weixin/addon/lottery/edit.html';
                }
    }
    ...
    public function sn($lottery_id, $page_id)
    {
        if (! ($lottery_id = (int) $lottery_id) && ! ($lottery_id = $this->GP('lottery_id'))) {
            ...
            if (! $detail = K::M('weixin/lottery')->detail($lottery_id)) {
                ...
                $this->tmpl = 'rzps/weixin/addon/lottery/sn.html';
            }
    }
