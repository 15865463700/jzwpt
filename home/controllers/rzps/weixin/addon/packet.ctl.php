...
class Ctl_Rzps_Weixin_Addon_Packet extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'rzps/weixin/addon/packet/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/weixin/addon/packet/create.html';
        }
    }
        ...
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'rzps/weixin/addon/packet/edit.html';
                }
    }
    ...
    public function sn($id, $page_id)
    {
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                $this->tmpl = 'rzps/weixin/addon/packet/sn.html';
            }
    }
    ...
    public function logs($id, $page_id)
    {
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                $this->pagedata['detail'] = $detail;
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'rzps/weixin/addon/packet/logs.html';
            }
    }
