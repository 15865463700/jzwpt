...
class Ctl_Rzps_Weixin_Addon_Card extends Ctl_Rzps_Ruanzhuangpeishi

{
    ...
    
    {
        ...
        if ($res['errcode'] == 0 && $res['total_num'] > 0) {
            ...
            $this->tmpl = 'rzps/weixin/addon/card/index.html';
        } else {
    ...
    
    {
        ...
        $qrurl = $this->mklink('rzps/weixin/addon/card:wxqrcode', array(), array(
            'id' => $id
        ));
    ...
    
    {
        ...
        $qrurl = $this->mklink('rzps/weixin/addon/card:wxqrcode2', array(), array(
            'codeurl' => $url
        ));
    ...
    
    {
        ...
        if ($code = $this->GP('code')) {
            ...
            $this->tmpl = 'rzps/weixin/addon/card/form.html';
        }
    }
    ...
    
    {
        ...
        $this->tmpl = 'rzps/weixin/addon/card/wxqrcode2.html';
    }
    ...
    
    {
        ...
        $this->tmpl = 'rzps/weixin/addon/card/wxqrcode.html';
    }
