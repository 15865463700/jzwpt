...
class Ctl_Rzps_Index extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function index()
    {
        ...
        $this->pagedata['yuyue_company_count'] = K::M('rzpscompany/yuyue')->count(array(
            'uid' => $this->uid
        ));
        ...
        $items['yuyue_company_count'] = K::M('rzpscompany/yuyue')->items(array(
            'uid' => $this->uid
        ));
