...
// class Ctl_Rzps_Member extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Member extends Ctl
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'rzps/member/index.html';
    }
    ...
    public function info()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'rzps/member/info.html';
        }
    }
    ...
    public function passwd()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'rzps/member/passwd.html';
        }
    }

    public function passwds()
    {
        $this->tmpl = 'rzps/member/passwds.html';
    }
    ...
    public function mail()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'rzps/member/mail.html';
        }
    }

    public function face()
    {
        $this->tmpl = 'rzps/member/face.html';
    }
    ...
    public function bindaccount()
    {
        ...
        $this->tmpl = 'rzps/member/bindaccount.html';
    }
    ...
    public function gold()
    {
        ...
        $this->tmpl = 'rzps/member/gold.html';
    }
    ...
    public function truste($truste, $truste_id)
    {
        if ($truste < 1) {
            ...
            $this->pagedata['pay_list'] = K::M('payment/payment')->fetch_all();
            $this->tmpl = 'rzps/member/truste.html';
        }
    }
    ...
    public function logs($type = null, $page = 0)
    {
        ...
        if ($items = K::M('member/log')->items($filter, null, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('rzps/member:logs', array(
                '{page}'
            )));
            $this->pagedata['items'] = $items;
        }
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/logs.html';
    }
    ...
    public function jflogs($type = null, $page = 0)
    {
        ...
        if ($items = K::M('fenxiao/log')->items($filter, null, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('rzps/member:jflogs', array(
                '{page}'
            )));
            $this->pagedata['items'] = $items;
        }
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/jflogs.html';
    }
    ...
    public function home($uid)
    {
        ...
        // $this->error(404);
        // }
        $url = $this->mklink('rzps:detail', $this->uid);
        header("Location:{$url}");
        exit();
    }
    ...
    public function fenxiao()
    {
        ...
        $this->tmpl = 'rzps/member/fenxiao.html';
    }
    ...
    public function topics()
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/topics/index.html';
    }
        ...
        if (! $topics_id = (int) $topics_id) {
            ...
            if (! $detail = K::M('topics/topics')->detail($topics_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->tmpl = 'rzps/member/topics/detail.html';
                }
    }
}