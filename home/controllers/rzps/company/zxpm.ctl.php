...
// class Ctl_Rzps_Company_Zxpm extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Company_Zxpm extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        // }
        $this->tmpl = 'rzps/company/zxpm/items.html';
    }
    ...
    public function detail($site_id = null)
    {
        ...
        if (! $site_id) {
            ...
            $this->tmpl = 'rzps/company/zxpm/detail.html';
        }
    }
