...
// class Ctl_Rzps_Company_Money extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Company_Money extends Ctl
{
    ...
    public function company($type = 'all', $page = 1)
    {
        ...
        $this->tmpl = 'rzps/company/money/items.html';
    }
    ...
    public function tixian()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/company/money/tixian.html';
        }
    }
}