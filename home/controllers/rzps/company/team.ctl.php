...
// class Ctl_Rzps_Company_Team extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Company_Team extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'rzps/company/team/items.html';
    }
    ...
    public function bind()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/company/team/bind.html';
        }
    }
