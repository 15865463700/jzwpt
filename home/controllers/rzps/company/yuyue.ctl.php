...
class Ctl_Rzps_Company_Yuyue extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function company($page = 1)
    {
        ...
        $this->tmpl = 'rzps/company/yuyue/items.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('company/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->tmpl = 'rzps/company/yuyue/detail.html';
                }
    }
    ...
    public function designer($page = 1)
    {
        ...
        $this->tmpl = 'rzps/company/yuyue/designer.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('designer/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'rzps/company/yuyue/designerDetail.html';
                }
    }
