...
// class Ctl_Rzps_Company_Tuan extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Company_Tuan extends Ctl
{
    ...
    public function index($page)
    {
        ...
        $this->tmpl = 'rzps/company/tuan/items.html';
        // }
    }
    ...
    public function sign($tuan_id, $page)
    {
        ...
        if (! $tuan_id = (int) $tuan_id) {
            ...
            if (! $tuan = K::M('home/tuan')->detail($tuan_id)) {
                ...
                $this->tmpl = 'rzps/company/tuan/sign.html';
            }
    }
}