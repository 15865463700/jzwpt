...
// class Ctl_Rzps_Company_Banner extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Company_Banner extends Ctl
{
    ...
    public function index()
    {
        ...
        $count = 0;
        if ($items = K::M('rzpscompany/banner')->items_by_company($company['company_id'])) {
        ...
        $this->tmpl = 'rzps/company/banners.html';
    }
        ...
        if ($allow_banner < 0) {
            ...
            if (! $attach = $_FILES['Filedata']) {
                ...
                if (UPLOAD_ERR_OK != $attach['error']) {
                    ...
                    if (K::M('company/banner')->count_by_company($company['company_id']) > 5) {
