...
// class Ctl_Rzps_Member_Packet extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Member_Packet extends Ctl
{
    ...
    public function items($type = 1, $page = 1)
    {
        ...
        $this->tmpl = 'rzps/member/packet/index.html';
    }
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            if ($items = K::M('member/packet')->items(array(
                ...
                if (K::M('member/packet')->update($detail['id'], $data)) {
                    $this->err->add('添加红包成功');
                    $this->tmpl = 'rzps/member/packet/items.html';
                }
            } else {
