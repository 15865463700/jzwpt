...
class Ctl_Rzps_Member_Yuyue extends Ctl_Rzps_Ruanzhuangpeishi
{
    ...
    public function tenders($page = 1)
    {
        ...
        $this->tmpl = 'rzps/member/yuyue/tenders.html';
    }
        ...
        if (! $tenders_id = (int) $tenders_id) {
            ...
            if (! $detail = K::M('tenders/tenders')->detail($tenders_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->tmpl = 'rzps/member/yuyue/tendersDetail.html';
                }
    }
            ...
            if (! $detail = K::M('tenders/tenders')->detail($tenders_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->pagedata['detail'] = $detail;
                        $this->tmpl = 'rzps/member/yuyue/tendersEdit.html';
                    }
    }
    ...
    public function company($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/yuyue/company.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('company/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'rzps/member/yuyue/companyDetail.html';
                }
    }
    ...
    public function designer($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/yuyue/designer.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('designer/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'rzps/member/yuyue/designerDetail.html';
                }
    }
    ...
    public function gz($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/yuyue/gz.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('gz/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'rzps/member/yuyue/gzDetail.html';
                }
    }
    ...
    public function mechanic($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/yuyue/mechanic.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('mechanic/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'rzps/member/yuyue/mechanicDetail.html';
                }
    }
    ...
    public function shop($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'rzps/member/yuyue/shop.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('shop/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'rzps/member/yuyue/shopDetail.html';
                }
    }
}