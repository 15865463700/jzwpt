...
// class Ctl_Rzps_Member_Verify extends Ctl_Rzps_Ruanzhuangpeishi
class Ctl_Rzps_Member_Verify extends Ctl
{
    ...
    public function name()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'rzps/member/verify/name.html';
        }
    }
    ...
    public function mobile($loc = null)
    {
        if ($loc == 'send') {
            ...
            if ($data = $this->checksubmit('data')) {
                ...
                $this->tmpl = 'rzps/member/verify/mobile.html';
            }
    }
    ...
    public function mail($loc = null)
    {
        if ($loc == 'verify') {
            ...
            $this->tmpl = 'rzps/member/verify/mail.html';
        }
    }
}