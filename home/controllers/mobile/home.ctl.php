...
class Ctl_Mobile_Home extends Ctl_Mobile
{
    ...
    public function tuan($page = 1)
    {
        ...
        if ($items = K::M('home/tuan')->items($filter, null, $page, $limit, $count)) {
            ...
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('mobile/home:tuan', array(
                '{page}'
            ), array(), true), array(
                'kw' => $pager['sokw']
            ));
                ...
                if ($this->checksubmit()) {
                    if (! $data = $this->GP('data')) {
                        ...
                        if ($sign_id = K::M('home/sign')->create($data)) {
                            ...
                            $this->err->set_data('forward', $this->mklink('mobile/home:tuandetail', array(
                                $tuan_id
                            )));
                        }
                    }
                    ...
                    $pager['backurl'] = $this->mklink('mobile/home:tuandetail', array(
                        $tuan_id
                    ));
                    $this->pagedata['pager'] = $pager;
