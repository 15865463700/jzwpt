...
class Ctl_Ucenter_Index extends Ctl_Ucenter
{
    ...
    public function tip() {
        $args = $_REQUEST["args"];
        $wdzxb_count = K::M('zxb/zxb')->count("uid='{$args}' and see=0 and status<3");
        $this->err->set_data('wdzxb',array("count" => $wdzxb_count,));
//        $this->err->set_data('gsts',array("count" => $gsts_count,));
        $this->err->json();
    }
