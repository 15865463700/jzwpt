<?php
class Ctl_Ucenter_Member_Zxb extends Ctl_Ucenter {
    ...
    public function index($page = 1) {
        ...
        $this->tmpl = 'ucenter/member/zxb/items.html';
    }
    ...
    public function lists($zxb_id) {
        ...
        if (!$detail = K::M('zxb/zxb')->detail($zxb_id)) {
            ...
            K::M('zxb/zxb')->update($zxb_id,array("see"=>1,));
            ...
            $this->tmpl = 'ucenter/member/zxb/lists.html';
        }
    }
    ...
    public function detail($zxb_id, $status) {
        if ($items = K::M('zxb/zxb')->detail($zxb_id)) {
            if (!$company_list = K::M('zxb/zxb')->items(array(
                ...
                $this->pagedata['member'] = K::M('member/member')->detail($this->uid);
                $this->pagedata['status'] = K::M('zxb/zxb')->get_status();
                $items['dealline_format']=date("Y-m-d H:i",$items['dealline']);
                $this->pagedata['editlink'] = "/ucenter/member/zxb-detail-{$zxb_id}-{$status}-1.html";//editlink
                $this->pagedata['zxb_id'] = $zxb_id;
                $this->pagedata['edit_enable'] = $tag;
                        ...
                        if (!$member = K::M('member/member')->detail($this->uid)) {
                            ...
                            if ($this->checksubmit('data')) {
                                if (!$data = $this->GP('data')) {
                                    ...
                                    if (!$mobile = K::M('verify/check')->phone($data['yezhu_phone'])) {
...
//                }
                                ...
                                $this->tmpl = 'ucenter/member/zxb/hetong.html';
                            }
                        }
    }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                                ...
                                if ($step_list['uid']) {
                                    ...
                                    if (!$step_id = $this->GP('step_id')) {
                                        ...
                                        if (K::M('zxb/step')->update($step_id, $data)) {
                                            if($status==6){
                                                K::M('zxb/zxb')->update($zxb_id, array("back"=>$_REQUEST["back"],"dealline"=>time()+86400*$_REQUEST['back'],));
                                            }
                                            $this->err->add('修改内容成功');
                                        }
                                    }
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'ucenter/member/zxb/detail.html';
                        }
                    }
    }
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            if (!$data = $this->GP('data')) {
                                ...
                                $data['yezhu_time'] = __TIME;
                                $data['zxb_id'] = $zxb_id;
                                if($_REQUEST['back']==10000000){
                                    $data['dealline']=time();
                                }else{
                                    $data['dealline']=time()+86400*$_REQUEST['back'];
                                }
                                // $data['dealline']=time()+86400*$_REQUEST['back'];
                                // echo $data['dealline'];die;
                                $data['step'] = $status;
                                if ($step_list['uid']) {
                                    ...
                                    if (!$step_id = $this->GP('step_id')) {
                                        ...
                                        if (K::M('zxb/step')->update($step_id, $data)) {
                                            if($_REQUEST['back']==10000000){
                                                $data['dealline']=time();
                                                K::M('zxb/zxb')->update($zxb_id, array("back"=>$_REQUEST["back"],"dealline"=>time(),));
                                                $this->err->add('修改内容成功');
                                            }else{
                                                $data['dealline']=time()+86400*$_REQUEST['back'];
                                                K::M('zxb/zxb')->update($zxb_id, array("back"=>$_REQUEST["back"],"dealline"=>time()+86400*$_REQUEST['back'],));
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'ucenter/member/zxb/endstep.html';
                        }
                    }
    }
                ...
                if (!$detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['zxb_id'] = $zxb_id;
                            $this->tmpl = 'ucenter/member/zxb/look.html';
                        }
                    }
    }
                ...
                if (!$detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if (!$plaint = K::M('zxb/plaint')->items(array(
                            ...
                            $this->tmpl = 'ucenter/member/zxb/plaint.html';
                        }
    }
                    ...
                    if (!$detail['company_id']) {
                        ...
                        if (empty($detail['audit'])) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->pagedata['zxb_id'] = $zxb_id;
                                $this->pagedata['plaint'] = $plaint;
                                $this->tmpl = 'ucenter/member/zxb/plaintedit.html';
                            }
                        }
    }
    ...
    public function gz($zxb_id) {
        ...
        if (!$detail = K::M('zxb/zxb')->detail($zxb_id)) {
            ...
            $this->pagedata['item'] = $detail;
            $this->pagedata['cityList'] = K::M("data/city")->fetch_all();
            $this->tmpl = 'ucenter/member/zxb/gz.html';
        }
    }
    ...
    public function gzxq($zxb_id, $status) {
        ...
        }elseif($status > 3 && $status < $items['cfg']['step']+4) {
            $this->gzlc($zxb_id, $status);
        }elseif(in_array($status ,array($items['cfg']['step']+4,$items['cfg']['step']+5))){
...
//                }
                                ...
                                $this->pagedata['now_status'] = $status;
                                $this->tmpl = 'ucenter/member/zxb/gzht.html';
                            }
                        }
                    }
                }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'ucenter/member/zxb/gzxq.html';
                        }
                    }
                }
            }
...
//                                                $data['dealline']=time()+86400*$_REQUEST['back'];
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'ucenter/member/zxb/endgzlc.html';
                        }
                    }
                }
            }
