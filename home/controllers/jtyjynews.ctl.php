...
class Ctl_Jtyjynews extends Ctl
{
    ...
    public function items($page = 1)
    {
        ...
        $filter['audit'] = 1;
        if ($items = K::M('jtyjycompany/news')->items($filter, $orderby, $page, $limit, $count)) {
            $pager['count'] = $count;
        ...
        $this->tmpl = 'jtyjynews/items.html';
    }
    ...
    public function detail($news_id)
    {
        ...
        if (! $news_id = (int) $news_id) {
            ...
            if (! $detail = K::M('jtyjycompany/news')->detail($news_id)) {
                ...
                K::M('jtyjycompany/news')->update_count($news_id, 'views', 1);
                $jtyjycompany = $this->check_company($detail['company_id']);
                ...
                $this->tmpl = 'jtyjynews/detail.html';
            }
    }
