...
class Ctl_Gybj_Shop_Coupon extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'gybj/shop/coupon/items.html';
    }
                ...
                if ($allow_coupon < 0) {
                    ...
                    if (! $data = $this->check_fields($data, $this->_allow_fields)) {
                        ...
                        if ($coupon_id = K::M('shop/coupon')->create($data)) {
                            ...
                            $this->err->set_data('forward', $this->mklink('gybj/shop/coupon:index'));
                        }
                    }
            } else {
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'gybj/shop/coupon/create.html';
            }
    }
            ...
            if (! $detail = K::M('shop/coupon')->detail($coupon_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'gybj/shop/coupon/edit.html';
                    }
    }
    ...
    public function downloads($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/shop/coupon/downloads.html';
    }
        ...
        if (! $download_id = (int) $download_id) {
            ...
            if (! $detail = K::M('shop/couponDownload')->detail($download_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/shop/coupon/downloadDetail.html';
                }
    }
