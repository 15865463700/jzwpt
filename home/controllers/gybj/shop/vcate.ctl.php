...
class Ctl_Gybj_Shop_Vcate extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'gybj/shop/vcate/items.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/shop/vcate/create.html';
        }
    }
            ...
            if (! $detail = K::M('shop/vcate')->detail($vcat_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'gybj/shop/vcate/edit.html';
                    }
    }
