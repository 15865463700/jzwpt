 ...
 * Class Ctl_Gybj
 */
class Ctl_Gybj_Jiatingyingjuyuan extends Ctl
{
    ...
    // // $this->company = K::M('gybjcompany/company')->company_by_uid($this->MEMBER['uid']);
    // // }
    // //
    ...
    // $this->response();
    // }else if($this->company = K::M('gybjcompany/company')->company_by_uid($this->uid)){
    ...
    // return $this->company;
    // }else if($this->request['ctl'] == 'gybj/company' && $this->request['act'] == 'info'){
    ...
    // return $this->shop;
    // }else if($this->request['ctl'] == 'gybj/shop' && $this->request['act'] == 'info'){
    ...
    // $this->tmpl = 'gybj/passport/login.html';
    // }
    // $this->err->response();
    // exit();
    // }
