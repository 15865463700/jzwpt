...
class Ctl_Gybj_Weixin extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function config()
    {
        ...
        $this->tmpl = 'gybj/weixin/config.html';
    }
    ...
    public function welcome()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/weixin/welcome.html';
        }
    }
    ...
    public function leaflets()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/weixin/leaflets.html';
        }
    }
}