...
// class Ctl_Gybj_Member extends Ctl_Gybj_Jiatingyingjuyuan
class Ctl_Gybj_Member extends Ctl
{
    ...
    public function index()
    {
        ...
        $this->pagedata['yuyue_company_count'] = K::M('gybjcompany/yuyue')->count(array(
            'uid' => $this->uid
        ));
        ...
        $items['yuyue_company_count'] = K::M('gybjcompany/yuyue')->items(array(
            'uid' => $this->uid
        ));
        ...
        $this->tmpl = 'gybj/member/index.html';
    }
    ...
    public function info()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'gybj/member/info.html';
        }
    }
    ...
    public function passwd()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'gybj/member/passwd.html';
        }
    }

    public function passwds()
    {
        $this->tmpl = 'gybj/member/passwds.html';
    }
    ...
    public function mail()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'gybj/member/mail.html';
        }
    }

    public function face()
    {
        $this->tmpl = 'gybj/member/face.html';
    }
    ...
    public function bindaccount()
    {
        ...
        $this->tmpl = 'gybj/member/bindaccount.html';
    }
    ...
    public function gold()
    {
        ...
        $this->tmpl = 'gybj/member/gold.html';
    }
    ...
    public function truste($truste, $truste_id)
    {
        if ($truste < 1) {
            ...
            $this->pagedata['pay_list'] = K::M('payment/payment')->fetch_all();
            $this->tmpl = 'gybj/member/truste.html';
        }
    }
    ...
    public function logs($type = null, $page = 0)
    {
        ...
        if ($items = K::M('member/log')->items($filter, null, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('gybj/member:logs', array(
                '{page}'
            )));
            $this->pagedata['items'] = $items;
        }
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/logs.html';
    }
    ...
    public function jflogs($type = null, $page = 0)
    {
        ...
        if ($items = K::M('fenxiao/log')->items($filter, null, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('gybj/member:jflogs', array(
                '{page}'
            )));
            $this->pagedata['items'] = $items;
        }
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/jflogs.html';
    }
    ...
    public function home($uid)
    {
        ...
        // $this->error(404);
        // }
        $url = $this->mklink('gybj:detail', $this->uid);
        header("Location:{$url}");
        exit();
    }
    ...
    public function fenxiao()
    {
        ...
        $this->tmpl = 'gybj/member/fenxiao.html';
    }
    ...
    public function topics()
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/topics/index.html';
    }
        ...
        if (! $topics_id = (int) $topics_id) {
            ...
            if (! $detail = K::M('topics/topics')->detail($topics_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->tmpl = 'gybj/member/topics/detail.html';
                }
    }
}