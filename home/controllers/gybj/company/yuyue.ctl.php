...
class Ctl_Gybj_Company_Yuyue extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function company($page = 1)
    {
        ...
        $this->tmpl = 'gybj/company/yuyue/items.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('gybjcompany/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->tmpl = 'gybj/company/yuyue/detail.html';
                }
    }
    ...
    public function designer($page = 1)
    {
        ...
        $this->tmpl = 'gybj/company/yuyue/designer.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('designer/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/company/yuyue/designerDetail.html';
                }
    }
