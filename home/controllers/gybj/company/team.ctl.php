...
// class Ctl_Gybj_Company_Team extends Ctl_Gybj_Jiatingyingjuyuan
class Ctl_Gybj_Company_Team extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'gybj/company/team/items.html';
    }
    ...
    public function bind()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/company/team/bind.html';
        }
    }
