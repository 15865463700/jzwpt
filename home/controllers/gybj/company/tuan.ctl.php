...
// class Ctl_Gybj_Company_Tuan extends Ctl_Gybj_Jiatingyingjuyuan
class Ctl_Gybj_Company_Tuan extends Ctl
{
    ...
    public function index($page)
    {
        ...
        $this->tmpl = 'gybj/company/tuan/items.html';
        // }
    }
    ...
    public function sign($tuan_id, $page)
    {
        ...
        if (! $tuan_id = (int) $tuan_id) {
            ...
            if (! $tuan = K::M('home/tuan')->detail($tuan_id)) {
                ...
                $this->tmpl = 'gybj/company/tuan/sign.html';
            }
    }
}