...
// class Ctl_Gybj_Company_Money extends Ctl_Gybj_Jiatingyingjuyuan
class Ctl_Gybj_Company_Money extends Ctl
{
    ...
    public function company($type = 'all', $page = 1)
    {
        ...
        $this->tmpl = 'gybj/company/money/items.html';
    }
    ...
    public function tixian()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/company/money/tixian.html';
        }
    }
}