 ...
 * $Id$
 */
class Ctl_Gybj_Member_Zxb extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        if ($items = K::M('zxb/zxb')->items($filter, array(
            ...
            if ($companys) {
                $this->pagedata['companys'] = K::M('gybjcompany/company')->items_by_ids($companys);
            }
        ...
        $this->tmpl = 'gybj/member/zxb/items.html';
    }
    ...
    public function lists($zxb_id)
    {
        ...
        if (! $detail = K::M('zxb/zxb')->detail($zxb_id)) {
            ...
            $this->tmpl = 'gybj/member/zxb/lists.html';
        }
    }
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if (! $member = K::M('member/member')->detail($this->uid)) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->tmpl = 'gybj/member/zxb/hetong.html';
                            }
                        }
    }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'gybj/member/zxb/detail.html';
                        }
                    }
    }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'gybj/member/zxb/endstep.html';
                        }
                    }
    }
                ...
                if (! $detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->tmpl = 'gybj/member/zxb/look.html';
                        }
                    }
    }
                ...
                if (! $detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if (! $plaint = K::M('zxb/plaint')->items(array(
                            ...
                            $this->tmpl = 'gybj/member/zxb/plaint.html';
                        }
    }
                    ...
                    if (! $detail['company_id']) {
                        ...
                        if (empty($detail['audit'])) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->pagedata['zxb_id'] = $zxb_id;
                                $this->pagedata['plaint'] = $plaint;
                                $this->tmpl = 'gybj/member/zxb/plaintedit.html';
                            }
                        }
    }
}