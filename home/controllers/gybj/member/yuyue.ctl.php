...
class Ctl_Gybj_Member_Yuyue extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function tenders($page = 1)
    {
        ...
        $this->tmpl = 'gybj/member/yuyue/tenders.html';
    }
        ...
        if (! $tenders_id = (int) $tenders_id) {
            ...
            if (! $detail = K::M('tenders/tenders')->detail($tenders_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    if ($look_list = K::M('tenders/look')->items_by_tenders($tenders_id)) {
                        ...
                        if ($uids) {
                            if ($member_list = K::M('member/member')->items_by_ids($uids)) {
                                ...
                                if ($company_uids) {
                                    $this->pagedata['company_list'] = K::M('gybjcompany/company')->items_by_uids($company_uids);
                                }
                                if ($shop_uids) {
                    ...
                    $this->tmpl = 'gybj/member/yuyue/tendersDetail.html';
                }
    }
            ...
            if (! $detail = K::M('tenders/tenders')->detail($tenders_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->pagedata['detail'] = $detail;
                        $this->tmpl = 'gybj/member/yuyue/tendersEdit.html';
                    }
    }
                                    ...
                                    if (K::M('tenders/look')->sign($look_id)) {
                                        switch ($member['from']) {
                                            ...
                                            case 'mechanic':
                                                ...
                                                break;
                                            case 'company':
                                                $company = K::M('gybjcompany/company')->items(array(
                                                    'uid' => $look['uid']
                                                ));
                                                foreach ($company as $k => $v) {
                                                    $this->company['company_id'] = $v['company_id'];
                                                }
                                                K::M('gybjcompany/company')->update_count($this->company['company_id'], 'tenders_sign');
                                            case 'shop':
                                        ...
                                        if ($zxb_id = (int) $tenders['zxb_id']) {
                                            if (! $company = K::M('gybjcompany/company')->company_by_uid($look['uid'])) {
    ...
    public function company($page = 1)
    {
        ...
        $pager['count'] = $count = 0;
        $filter['uid'] = $this->uid;
        if ($items = K::M('gybjcompany/yuyue')->items($filter, $page, $limit, $count)) {
            $pager['count'] = $count;
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/yuyue/company.html';
    }
    ...
    public function companyDetail($yuyue_id = null)
    {
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('gybjcompany/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    if ($detail['company_id']) {
                        $this->pagedata['company'] = K::M('gybjcompany/company')->detail($detail['company_id']);
                    }
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/member/yuyue/companyDetail.html';
                }
    }
    ...
    public function designer($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/yuyue/designer.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('designer/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/member/yuyue/designerDetail.html';
                }
    }
    ...
    public function gz($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/yuyue/gz.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('gz/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/member/yuyue/gzDetail.html';
                }
    }
    ...
    public function mechanic($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/yuyue/mechanic.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('mechanic/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/member/yuyue/mechanicDetail.html';
                }
    }
    ...
    public function shop($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'gybj/member/yuyue/shop.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('shop/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/member/yuyue/shopDetail.html';
                }
    }
}