...
// class Ctl_Gybj_Member_Verify extends Ctl_Gybj_Jiatingyingjuyuan
class Ctl_Gybj_Member_Verify extends Ctl
{
    ...
    public function name()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/member/verify/name.html';
        }
    }
    ...
    public function mobile($loc = null)
    {
        if ($loc == 'send') {
            ...
            if ($data = $this->checksubmit('data')) {
                ...
                $this->tmpl = 'gybj/member/verify/mobile.html';
            }
    }
    ...
    public function mail($loc = null)
    {
        if ($loc == 'verify') {
            ...
            $this->tmpl = 'gybj/member/verify/mail.html';
        }
    }
}