...
class Ctl_Gybj_Weixin_Addon_Card extends Ctl_Gybj_Jiatingyingjuyuan

{
    ...
    
    {
        ...
        if ($res['errcode'] == 0 && $res['total_num'] > 0) {
            ...
            $this->tmpl = 'gybj/weixin/addon/card/index.html';
        } else {
    ...
    
    {
        ...
        $qrurl = $this->mklink('gybj/weixin/addon/card:wxqrcode', array(), array(
            'id' => $id
        ));
    ...
    
    {
        ...
        $qrurl = $this->mklink('gybj/weixin/addon/card:wxqrcode2', array(), array(
            'codeurl' => $url
        ));
    ...
    
    {
        ...
        if ($code = $this->GP('code')) {
            ...
            $this->tmpl = 'gybj/weixin/addon/card/form.html';
        }
    }
    ...
    
    {
        ...
        $this->tmpl = 'gybj/weixin/addon/card/wxqrcode2.html';
    }
    ...
    
    {
        ...
        $this->tmpl = 'gybj/weixin/addon/card/wxqrcode.html';
    }
