...
class Ctl_Gybj_Weixin_Addon_Packet extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'gybj/weixin/addon/packet/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/weixin/addon/packet/create.html';
        }
    }
        ...
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'gybj/weixin/addon/packet/edit.html';
                }
    }
    ...
    public function sn($id, $page_id)
    {
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                $this->tmpl = 'gybj/weixin/addon/packet/sn.html';
            }
    }
    ...
    public function logs($id, $page_id)
    {
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                $this->pagedata['detail'] = $detail;
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'gybj/weixin/addon/packet/logs.html';
            }
    }
