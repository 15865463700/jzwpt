...
class Ctl_Gybj_Weixin_Addon_Goldegg extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'gybj/weixin/addon/goldegg/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/weixin/addon/goldegg/create.html';
        }
    }
        ...
        if (! ($goldegg_id = (int) $goldegg_id) && ! ($goldegg_id = $this->GP('goldegg_id'))) {
            ...
            if (! $detail = K::M('weixin/goldegg')->detail($goldegg_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'gybj/weixin/addon/goldegg/edit.html';
                }
    }
    ...
    public function sn($goldegg_id, $page_id)
    {
        if (! ($goldegg_id = (int) $goldegg_id) && ! ($goldegg_id = $this->GP('goldegg_id'))) {
            ...
            if (! $detail = K::M('weixin/goldegg')->detail($goldegg_id)) {
                ...
                $this->tmpl = 'gybj/weixin/addon/goldegg/sn.html';
            }
    }
