...
class Ctl_Gybj_Weixin_Addon_Scratch extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'gybj/weixin/addon/scratch/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/weixin/addon/scratch/create.html';
        }
    }
        ...
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'gybj/weixin/addon/scratch/edit.html';
                }
    }
    ...
    public function sn($scratch_id, $page_id)
    {
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                $this->tmpl = 'gybj/weixin/addon/scratch/sn.html';
            }
    }
    ...
    public function goods($scratch_id, $page_id)
    {
        ...
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                $this->pagedata['detail'] = $detail;
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'gybj/weixin/addon/scratch/goods.html';
            }
    }
        ...
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'gybj/weixin/addon/scratch/goodscreate.html';
                }
    }
        ...
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/prize')->detail($id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'gybj/weixin/addon/scratch/goodsedit.html';
                }
    }
