...
class Ctl_Gybj_Weixin_Msite extends Ctl_Gybj_Jiatingyingjuyuan
{
    ...
    {
        $this->tmpl = 'gybj/weixin/msite/access.html';
    }
    ...
    public function index()
    {
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'gybj/weixin/msite/index.html';
        }
    }
    ...
    public function tmpl($from = 'index')
    {
        ...
        if ($tmpl = $this->checksubmit('template')) {
            ...
            $this->tmpl = 'gybj/weixin/msite/tmpl.html';
        }
    }
