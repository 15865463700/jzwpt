 ...
 * $Id$
 */
class Ctl_Scenter_Company_News extends Ctl_Scenter
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'scenter/company/news/items.html';
    }
                ...
                if ($allow_news < 0) {
                    ...
                    if (! $data = $this->check_fields($data, $this->_allow_fields)) {
                        ...
                        if ($news_id = K::M('company/news')->create($data)) {
                            ...
                            $this->err->set_data('forward', $this->mklink('scenter/company/news:index'));
                        }
                    }
            } else {
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'scenter/company/news/create.html';
            }
    }
            ...
            if (! $detail = K::M('company/news')->detail($news_id)) {
                ...
                if ($company['company_id'] != $detail['company_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'scenter/company/news/edit.html';
                    }
    }
