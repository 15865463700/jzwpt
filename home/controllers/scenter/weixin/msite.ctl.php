...
class Ctl_Scenter_Weixin_Msite extends Ctl_Scenter
{
    ...
    {
        $this->tmpl = 'scenter/weixin/msite/access.html';
    }
    ...
    public function index()
    {
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'scenter/weixin/msite/index.html';
        }
    }
    ...
    public function tmpl($from = 'index')
    {
        ...
        if ($tmpl = $this->checksubmit('template')) {
            ...
            $this->tmpl = 'scenter/weixin/msite/tmpl.html';
        }
    }
