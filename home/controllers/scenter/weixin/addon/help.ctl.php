...
class Ctl_Scenter_Weixin_Addon_Help extends Ctl_Scenter
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'scenter/weixin/addon/help/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'scenter/weixin/addon/help/create.html';
        }
    }
        ...
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'scenter/weixin/addon/help/edit.html';
                }
    }
    ...
    public function sn($help_id, $page_id)
    {
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                $this->tmpl = 'scenter/weixin/addon/help/sn.html';
            }
    }
    ...
    public function goods($help_id, $page_id)
    {
        ...
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                $this->pagedata['detail'] = $detail;
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'scenter/weixin/addon/help/goods.html';
            }
    }
        ...
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'scenter/weixin/addon/help/goodscreate.html';
                }
    }
        ...
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/helpprize')->detail($id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'scenter/weixin/addon/help/goodsedit.html';
                }
    }
    ...
    public function snlist($sn_id, $page_id)
    {
        ...
        if (! $sn_id) {
            ...
            $this->pagedata['detail'] = $detail;
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'scenter/weixin/addon/help/snlist.html';
        }
    }
}