...
class Ctl_Scenter_Member extends Ctl_Scenter
{
    ...
    public function info()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'scenter/member/info.html';
        }
    }
    ...
    public function passwd()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'scenter/member/passwd.html';
        }
    }

    public function passwds()
    {
        $this->tmpl = 'scenter/member/passwds.html';
    }
    ...
    public function mail()
    {
        if ($account = $this->checksubmit('account')) {
            ...
            $this->tmpl = 'scenter/member/mail.html';
        }
    }

    public function face()
    {
        $this->tmpl = 'scenter/member/face.html';
    }
    ...
    public function bindaccount()
    {
        ...
        $this->tmpl = 'scenter/member/bindaccount.html';
    }
    ...
    public function gold()
    {
        ...
        $this->tmpl = 'scenter/member/gold.html';
    }
    ...
    public function truste($truste, $truste_id)
    {
        if ($truste < 1) {
            ...
            $this->pagedata['pay_list'] = K::M('payment/payment')->fetch_all();
            $this->tmpl = 'scenter/member/truste.html';
        }
    }
    ...
    public function logs($type = null, $page = 0)
    {
        ...
        if ($items = K::M('member/log')->items($filter, null, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('scenter/member:logs', array(
                '{page}'
            )));
            $this->pagedata['items'] = $items;
        }
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/logs.html';
    }
    ...
    public function jflogs($type = null, $page = 0)
    {
        ...
        $pager['page'] = max(intval($page), 1);
        $pager['limit'] = $limit = 20;
        $filter1['uid'] = $this->uid;
        if ($items = K::M('fenxiao/log')->items($filter1, null, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('scenter/member:jflogs', array(
                '{page}'
            )));
            $this->pagedata['items'] = $items;
        }
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/jflogs.html';
    }
    ...
    public function coupon($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/coupon.html';
    }

    public function group()
    {
        $this->pagedata['group_list'] = K::M('member/group')->items_by_from($this->MEMBER['from']);
        $this->tmpl = 'scenter/member/group/group.html';
    }
    ...
    public function fenxiao()
    {
        ...
        $this->tmpl = 'scenter/member/fenxiao.html';
    }
    ...
    public function topics()
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/topics/index.html';
    }
        ...
        if (! $topics_id = (int) $topics_id) {
            ...
            if (! $detail = K::M('topics/topics')->detail($topics_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->tmpl = 'scenter/member/topics/detail.html';
                }
    }
}