...
class Ctl_Scenter_Weixin extends Ctl_Scenter
{
    ...
    public function config()
    {
        ...
        $this->tmpl = 'scenter/weixin/config.html';
    }
    ...
    public function welcome()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'scenter/weixin/welcome.html';
        }
    }
    ...
    public function leaflets()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'scenter/weixin/leaflets.html';
        }
    }
}