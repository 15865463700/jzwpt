 ...
 * $Id$
 */
class Ctl_Scenter_Member_Verify extends Ctl_Scenter
{
    ...
    public function name()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'scenter/member/verify/name.html';
        }
    }
    ...
    public function mobile($loc = null)
    {
        if ($loc == 'send') {
            ...
            if ($data = $this->checksubmit('data')) {
                ...
                $this->tmpl = 'scenter/member/verify/mobile.html';
            }
    }
    ...
    public function mail($loc = null)
    {
        if ($loc == 'verify') {
            ...
            $this->tmpl = 'scenter/member/verify/mail.html';
        }
    }
}