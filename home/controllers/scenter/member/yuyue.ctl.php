...
class Ctl_Scenter_Member_Yuyue extends Ctl_Scenter
{
    ...
    public function tenders($page = 1)
    {
        ...
        $this->tmpl = 'scenter/member/yuyue/tenders.html';
    }
        ...
        if (! $tenders_id = (int) $tenders_id) {
            ...
            if (! $detail = K::M('tenders/tenders')->detail($tenders_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->tmpl = 'scenter/member/yuyue/tendersDetail.html';
                }
    }
            ...
            if (! $detail = K::M('tenders/tenders')->detail($tenders_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->pagedata['detail'] = $detail;
                        $this->tmpl = 'scenter/member/yuyue/tendersEdit.html';
                    }
    }
    ...
    public function company($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/yuyue/company.html';
    }
    ...
    public function companyDetail($yuyue_id = null)
    {
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('company/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'scenter/member/yuyue/companyDetail.html';
                }
    }
    ...
    public function designer($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/yuyue/designer.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('designer/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'scenter/member/yuyue/designerDetail.html';
                }
    }
    ...
    public function gz($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/yuyue/gz.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('gz/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'scenter/member/yuyue/gzDetail.html';
                }
    }
    ...
    public function mechanic($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/yuyue/mechanic.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('mechanic/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'scenter/member/yuyue/mechanicDetail.html';
                }
    }
    ...
    public function shop($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'scenter/member/yuyue/shop.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('shop/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'scenter/member/yuyue/shopDetail.html';
                }
    }
}