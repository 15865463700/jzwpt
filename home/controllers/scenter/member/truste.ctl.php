...
class Ctl_Scenter_Member_Truste extends Ctl_Scenter
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'scenter/member/truste/index.html';
    }
        ...
        if (! $truste_id = (int) $truste_id) {
            ...
            if (! $detail = K::M('truste/truste')->detail($truste_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->tmpl = 'scenter/member/truste/trusteDetail.html';
                }
    }
            ...
            if (! $detail = K::M('truste/truste')->detail($truste_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->pagedata['detail'] = $detail;
                        $this->tmpl = 'scenter/member/truste/trusteEdit.html';
                    }
    }
                            ...
                            if (! $truste['sign_from']) {
                                ...
                                if ($truste['comment_id']) {
                                    ...
                                    if ($data = $this->checksubmit('data')) {
                                        ...
                                        $this->tmpl = 'scenter/member/truste/comments.html';
                                    }
    }
