...
class Ctl_Jtyjy_Company_Yuyue extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function company($page = 1)
    {
        ...
        $this->tmpl = 'jtyjy/company/yuyue/items.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('jtyjycompany/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->tmpl = 'jtyjy/company/yuyue/detail.html';
                }
    }
    ...
    public function save()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            if (! $data = $this->check_fields($data, 'status,remark')) {
                ...
                if (! $yuyue_id = (int) $this->GP('yuyue_id')) {
    ...
    public function designer($page = 1)
    {
        ...
        $pager['limit'] = $limit = 20;
        $pager['count'] = $count = 0;
        if ($items = K::M('designer/yuyue')->items(array(
            'company_id' => $company['company_id']
        ...
        $this->tmpl = 'jtyjy/company/yuyue/designer.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('designer/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'jtyjy/company/yuyue/designerDetail.html';
                }
    }
