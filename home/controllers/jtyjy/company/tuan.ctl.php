...
// class Ctl_Jtyjy_Company_Tuan extends Ctl_Jtyjy_Jiatingyingjuyuan
class Ctl_Jtyjy_Company_Tuan extends Ctl
{
    ...
    public function index($page)
    {
        ...
        $this->tmpl = 'jtyjy/company/tuan/items.html';
        // }
    }
    ...
    public function sign($tuan_id, $page)
    {
        ...
        if (! $tuan_id = (int) $tuan_id) {
            ...
            if (! $tuan = K::M('home/tuan')->detail($tuan_id)) {
                ...
                $this->pagedata['package'] = K::M('home/package')->items(array(
                    'tuan_id' => $tuan_id
                ));
                $this->tmpl = 'jtyjy/company/tuan/sign.html';
            }
    }
}