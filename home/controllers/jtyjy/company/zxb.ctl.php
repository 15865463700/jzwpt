 ...
 * $Id$
 */
class Ctl_Jtyjy_Company_Zxb extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        if ($company) {
            ...
            $this->tmpl = 'jtyjy/company/zxb/items.html';
        } else {
        ...
        if ($company) {
            if ($items = K::M('zxb/zxb')->detail($zxb_id)) {
                if (! $company_list = K::M('zxb/zxb')->items(array(
                    ...
                    $this->tmpl = 'jtyjy/company/zxb/lists.html';
                }
            } else {
                ...
                if ($detail['company_id'] < $company['company_id']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->tmpl = 'jtyjy/company/zxb/hetong.html';
                        }
                    }
    }
                ...
                if ($detail['company_id'] < $company['company_id']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'jtyjy/company/zxb/detail.html';
                        }
                    }
    }
                ...
                if ($detail['company_id'] < $company['company_id']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'jtyjy/company/zxb/endstep.html';
                        }
                    }
    }
                    ...
                    if (! $detail['company_id']) {
                        ...
                        if (empty($detail['audit'])) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->tmpl = 'jtyjy/company/zxb/look.html';
                            }
                        }
    }
                    ...
                    if (! $detail['company_id']) {
                        ...
                        if (empty($detail['audit'])) {
                            ...
                            if (! $plaint = K::M('zxb/plaint')->items(array(
                                ...
                                $this->tmpl = 'jtyjy/company/zxb/plaint.html';
                            }
    }
                        ...
                        if (! $detail['company_id']) {
                            ...
                            if (empty($detail['audit'])) {
                                ...
                                if ($this->checksubmit('data')) {
                                    ...
                                    $this->pagedata['zxb_id'] = $zxb_id;
                                    $this->pagedata['plaint'] = $plaint;
                                    $this->tmpl = 'jtyjy/company/zxb/plaintedit.html';
                                }
                            }
    }
}
