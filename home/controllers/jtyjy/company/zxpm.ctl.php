...
// class Ctl_Jtyjy_Company_Zxpm extends Ctl_Jtyjy_Jiatingyingjuyuan
class Ctl_Jtyjy_Company_Zxpm extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        // }
        $this->tmpl = 'jtyjy/company/zxpm/items.html';
    }
    ...
    public function detail($site_id = null)
    {
        ...
        if (! $site_id) {
            ...
            $this->tmpl = 'jtyjy/company/zxpm/detail.html';
        }
    }
