...
// class Ctl_Jtyjy_Company_Team extends Ctl_Jtyjy_Jiatingyingjuyuan
class Ctl_Jtyjy_Company_Team extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'jtyjy/company/team/items.html';
    }
    ...
    public function bind()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'jtyjy/company/team/bind.html';
        }
    }
