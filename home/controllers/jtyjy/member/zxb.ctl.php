 ...
 * $Id$
 */
class Ctl_Jtyjy_Member_Zxb extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        if ($items = K::M('zxb/zxb')->items($filter, array(
            ...
            if ($companys) {
                $this->pagedata['companys'] = K::M('jtyjycompany/company')->items_by_ids($companys);
            }
        ...
        $this->tmpl = 'jtyjy/member/zxb/items.html';
    }
    ...
    public function lists($zxb_id)
    {
        ...
        if (! $detail = K::M('zxb/zxb')->detail($zxb_id)) {
            ...
            $this->tmpl = 'jtyjy/member/zxb/lists.html';
        }
    }
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if (! $member = K::M('member/member')->detail($this->uid)) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->tmpl = 'jtyjy/member/zxb/hetong.html';
                            }
                        }
    }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'jtyjy/member/zxb/detail.html';
                        }
                    }
    }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'jtyjy/member/zxb/endstep.html';
                        }
                    }
    }
                ...
                if (! $detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->tmpl = 'jtyjy/member/zxb/look.html';
                        }
                    }
    }
                ...
                if (! $detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if (! $plaint = K::M('zxb/plaint')->items(array(
                            ...
                            $this->tmpl = 'jtyjy/member/zxb/plaint.html';
                        }
    }
                    ...
                    if (! $detail['company_id']) {
                        ...
                        if (empty($detail['audit'])) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->pagedata['zxb_id'] = $zxb_id;
                                $this->pagedata['plaint'] = $plaint;
                                $this->tmpl = 'jtyjy/member/zxb/plaintedit.html';
                            }
                        }
    }
}