...
// class Ctl_Jtyjy_Member_Verify extends Ctl_Jtyjy_Jiatingyingjuyuan
class Ctl_Jtyjy_Member_Verify extends Ctl
{
    ...
    public function name()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            if ($this->MEMBER['verify_name']) {
                ...
                if (! $data = $this->check_fields($data, 'name,mobile,id_number,id_photo')) {
            ...
            $this->tmpl = 'jtyjy/member/verify/name.html';
        }
    }
        ...
        if ($loc == 'send') {
            ...
            if ($data = $this->checksubmit('data')) {
                if (! $data['code']) {
                    ...
                    if ($verify = K::M('member/member')->items(array(
                ...
                $this->tmpl = 'jtyjy/member/verify/mobile.html';
            }
    }
    ...
    public function mail($loc = null)
    {
        if ($loc == 'verify') {
            ...
            $this->tmpl = 'jtyjy/member/verify/mail.html';
        }
    }
}