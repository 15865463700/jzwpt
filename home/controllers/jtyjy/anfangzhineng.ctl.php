 ...
 * Class Ctl_Jtyjy
 */
class Ctl_Jtyjy_Jiatingyingjuyuan extends Ctl
{
    ...
    // // $this->company = K::M('jtyjycompany/company')->company_by_uid($this->MEMBER['uid']);
    // // }
    // //
    ...
    // {
    // if($this->MEMBER['from'] != 'company'){
    // $this->err->add('您的帐号不是家庭影剧院公司类型', 211);
    // $this->response();
    // }else if($this->company = K::M('jtyjycompany/company')->company_by_uid($this->uid)){
    ...
    // return $this->company;
    // }else if($this->request['ctl'] == 'jtyjy/company' && $this->request['act'] == 'info'){
    ...
    // return $this->shop;
    // }else if($this->request['ctl'] == 'jtyjy/shop' && $this->request['act'] == 'info'){
    ...
    // $this->tmpl = 'jtyjy/weixin/nopriv.html';
    // }else if($this->weixin = K::M('weixin/weixin')->weixin_by_uid($this->uid)){
    // $this->pagedata['weixin'] = $this->weixin;
    // return $this->weixin;
    // }else if($this->request['ctl'] == 'jtyjy/weixin' && $this->request['act'] == 'info'){
    // $this->pagedata['weixin_no_open'] = true;
    // return false;
    // }else{
    // $this->pagedata['weixin_no_open'] = true;
    // $this->tmpl = 'jtyjy/weixin/info.html';
    // }
    // $this->response();
    // }
    //
    ...
    // $this->tmpl = 'jtyjy/passport/login.html';
    // }
    // $this->err->response();
    // exit();
    // }
