...
class Ctl_Jtyjy_Weixin_Addon_Packet extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $pager['page'] = $limit = 30;
        $pager['page'] = $count = 0;
        if ($items = K::M('weixin/packet')->items(array(
            'wx_id' => $weixin['wx_sid']
        ...
        $this->tmpl = 'jtyjy/weixin/addon/packet/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'jtyjy/weixin/addon/packet/create.html';
        }
    }
        ...
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'jtyjy/weixin/addon/packet/edit.html';
                }
    }
    ...
    public function sn($id, $page_id)
    {
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                $this->tmpl = 'jtyjy/weixin/addon/packet/sn.html';
            }
    }
    ...
    public function logs($id, $page_id)
    {
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/packet')->detail($id)) {
                ...
                $this->pagedata['detail'] = $detail;
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'jtyjy/weixin/addon/packet/logs.html';
            }
    }
