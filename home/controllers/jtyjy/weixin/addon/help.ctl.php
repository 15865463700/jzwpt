...
class Ctl_Jtyjy_Weixin_Addon_Help extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'jtyjy/weixin/addon/help/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'jtyjy/weixin/addon/help/create.html';
        }
    }
        ...
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'jtyjy/weixin/addon/help/edit.html';
                }
    }
    ...
    public function sn($help_id, $page_id)
    {
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                $this->tmpl = 'jtyjy/weixin/addon/help/sn.html';
            }
    }
    ...
    public function goods($help_id, $page_id)
    {
        ...
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                $this->pagedata['detail'] = $detail;
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'jtyjy/weixin/addon/help/goods.html';
            }
    }
        ...
        if (! ($help_id = (int) $help_id) && ! ($help_id = $this->GP('help_id'))) {
            ...
            if (! $detail = K::M('weixin/help')->detail($help_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'jtyjy/weixin/addon/help/goodscreate.html';
                }
    }
        ...
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/helpprize')->detail($id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'jtyjy/weixin/addon/help/goodsedit.html';
                }
    }
    ...
    public function snlist($sn_id, $page_id)
    {
        ...
        if (! $sn_id) {
            ...
            $this->pagedata['detail'] = $detail;
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'jtyjy/weixin/addon/help/snlist.html';
        }
    }
}