...
class Ctl_Jtyjy_Weixin_Addon_Lottery extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $pager['page'] = $limit = 30;
        $pager['page'] = $count = 0;
        if ($items = K::M('weixin/lottery')->items(array(
            'wx_id' => $weixin['wx_sid']
        ...
        $this->tmpl = 'jtyjy/weixin/addon/lottery/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'jtyjy/weixin/addon/lottery/create.html';
        }
    }
        ...
        if (! ($lottery_id = (int) $lottery_id) && ! ($lottery_id = $this->GP('lottery_id'))) {
            ...
            if (! $detail = K::M('weixin/lottery')->detail($lottery_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'jtyjy/weixin/addon/lottery/edit.html';
                }
    }
    ...
    public function sn($lottery_id, $page_id)
    {
        if (! ($lottery_id = (int) $lottery_id) && ! ($lottery_id = $this->GP('lottery_id'))) {
            ...
            if (! $detail = K::M('weixin/lottery')->detail($lottery_id)) {
                ...
                $this->tmpl = 'jtyjy/weixin/addon/lottery/sn.html';
            }
    }
