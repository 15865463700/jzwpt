...
class Ctl_Jtyjy_Weixin_Addon_Goldegg extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $pager['page'] = $limit = 30;
        $pager['page'] = $count = 0;
        if ($items = K::M('weixin/goldegg')->items(array(
            'wx_id' => $weixin['wx_sid']
        ...
        $this->tmpl = 'jtyjy/weixin/addon/goldegg/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'jtyjy/weixin/addon/goldegg/create.html';
        }
    }
        ...
        if (! ($goldegg_id = (int) $goldegg_id) && ! ($goldegg_id = $this->GP('goldegg_id'))) {
            ...
            if (! $detail = K::M('weixin/goldegg')->detail($goldegg_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'jtyjy/weixin/addon/goldegg/edit.html';
                }
    }
    ...
    public function sn($goldegg_id, $page_id)
    {
        if (! ($goldegg_id = (int) $goldegg_id) && ! ($goldegg_id = $this->GP('goldegg_id'))) {
            ...
            if (! $detail = K::M('weixin/goldegg')->detail($goldegg_id)) {
                ...
                $this->tmpl = 'jtyjy/weixin/addon/goldegg/sn.html';
            }
    }
