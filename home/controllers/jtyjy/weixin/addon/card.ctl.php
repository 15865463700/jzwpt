...
class Ctl_Jtyjy_Weixin_Addon_Card extends Ctl_Jtyjy_Jiatingyingjuyuan

{
    ...
    
    {
        ...
        if ($res['errcode'] == 0 && $res['total_num'] > 0) {
            ...
            $this->tmpl = 'jtyjy/weixin/addon/card/index.html';
        } else {
    ...
    
    {
        ...
        $qrurl = $this->mklink('jtyjy/weixin/addon/card:wxqrcode', array(), array(
            'id' => $id
        ));
    ...
    
    {
        ...
        $url = $site['siteurl'] . '/' . K::M('helper/link')->mklink('weixin/voucher:index', array(
            $weixin['wx_id']
        ));
        
        $qrurl = $this->mklink('jtyjy/weixin/addon/card:wxqrcode2', array(), array(
            'codeurl' => $url
        ));
    ...
    
    {
        ...
        if ($code = $this->GP('code')) {
            ...
            $this->tmpl = 'jtyjy/weixin/addon/card/form.html';
        }
    }
    ...
    
    {
        ...
        $this->tmpl = 'jtyjy/weixin/addon/card/wxqrcode2.html';
    }
    ...
    
    {
        ...
        $this->tmpl = 'jtyjy/weixin/addon/card/wxqrcode.html';
    }
