...
class Ctl_Jtyjy_Weixin extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function config()
    {
        ...
        $this->tmpl = 'jtyjy/weixin/config.html';
    }
    ...
    public function welcome()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            if ($data) {
                $addon['welcome'] = $data;
                if (K::M('weixin/weixin')->update($weixin['wx_id'], array(
                    'addon' => $addon
                ))) {
            ...
            $this->tmpl = 'jtyjy/weixin/welcome.html';
        }
    }
    ...
    public function leaflets()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'jtyjy/weixin/leaflets.html';
        }
    }
}