...
class Ctl_Jtyjy_Shop_Order extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($type = null, $page = 1)
    {
        ...
        $this->tmpl = 'jtyjy/shop/order/items.html';
    }
                                        ...
                                        if ($order['order_status'] == 1) {
                                            ...
                                            if (empty($order['order_status'])) {
                                                if (K::M('trade/order')->update($order['order_id'], array(
                                                    ...
                                                    if ($member['mail']) {
                                                        K::M('helper/mail')->sendmail($member['mail'], 'order_ship_buyer', $maildata);
                                                    }
                                                    $this->err->add('订单发货成功');
                                                }
                                            }
