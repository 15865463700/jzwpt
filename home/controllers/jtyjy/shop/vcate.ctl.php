...
class Ctl_Jtyjy_Shop_Vcate extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'jtyjy/shop/vcate/items.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'jtyjy/shop/vcate/create.html';
        }
    }
    ...
    public function edit($vcat_id = null)
    {
        ...
        if (! ($vcat_id = (int) $vcat_id) && ! ($vcat_id = (int) $this->GP('vcat_id'))) {
            ...
            if (! $detail = K::M('shop/vcate')->detail($vcat_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'jtyjy/shop/vcate/edit.html';
                    }
    }
