...
class Ctl_Jtyjy_Shop_Coupon extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'jtyjy/shop/coupon/items.html';
    }
                ...
                if ($allow_coupon < 0) {
                    ...
                    if (! $data = $this->check_fields($data, $this->_allow_fields)) {
                        ...
                        if ($coupon_id = K::M('shop/coupon')->create($data)) {
                            ...
                            $this->err->set_data('forward', $this->mklink('jtyjy/shop/coupon:index'));
                        }
                    }
            } else {
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'jtyjy/shop/coupon/create.html';
            }
    }
            ...
            if (! $detail = K::M('shop/coupon')->detail($coupon_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'jtyjy/shop/coupon/edit.html';
                    }
    }
    ...
    public function delete($coupon_id = null)
    {
        ...
        if (! ($coupon_id = (int) $coupon_id) && ! ($coupon_id = $this->GP('coupon_id'))) {
            ...
            if (! $detail = K::M('shop/coupon')->detail($coupon_id)) {
                ...
                if ($shop['shop_id'] != $detail['shop_id']) {
    ...
    public function downloads($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'jtyjy/shop/coupon/downloads.html';
    }
    ...
    public function downloadDetail($download_id = null)
    {
        ...
        if (! $download_id = (int) $download_id) {
            ...
            if (! $detail = K::M('shop/couponDownload')->detail($download_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'jtyjy/shop/coupon/downloadDetail.html';
                }
    }
    ...
    public function downloadSave()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            if (! $data = $this->check_fields($data, 'used,status,remark')) {
                ...
                if (! $download_id = (int) $this->GP('download_id')) {
