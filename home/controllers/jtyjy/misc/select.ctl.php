 ...
 * $Id$
 */
class Ctl_Jtyjy_Misc_Select extends Ctl_Jtyjy_Jiatingyingjuyuan
{
    ...
    public function mycase($page = 1)
    {
        ...
        $pager['limit'] = $limit = 10;
        $pager['count'] = $count = 0;
        if ($this->MEMBER['from'] == 'company' && ($company = K::M('jtyjycompany/company')->company_by_uid($this->MEMBER['uid']))) {
            $filter = array(
                'audit' => 1,
                'closed' => 0
            );
