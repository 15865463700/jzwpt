...
class Ctl_Afzn_Weixin extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function config()
    {
        ...
        $this->tmpl = 'afzn/weixin/config.html';
    }
    ...
    public function welcome()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/weixin/welcome.html';
        }
    }
    ...
    public function leaflets()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/weixin/leaflets.html';
        }
    }
}