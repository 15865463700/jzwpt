...
// class Ctl_Afzn_Member_Packet extends Ctl_Afzn_Anfangzhineng
class Ctl_Afzn_Member_Packet extends Ctl
{
    ...
    public function items($type = 1, $page = 1)
    {
        ...
        $this->tmpl = 'afzn/member/packet/index.html';
    }
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            if ($items = K::M('member/packet')->items(array(
                ...
                if (K::M('member/packet')->update($detail['id'], $data)) {
                    $this->err->add('添加红包成功');
                    $this->tmpl = 'afzn/member/packet/items.html';
                }
            } else {
