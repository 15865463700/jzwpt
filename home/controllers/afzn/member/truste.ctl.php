...
class Ctl_Afzn_Member_Truste extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'afzn/member/truste/index.html';
    }
        ...
        if (! $truste_id = (int) $truste_id) {
            ...
            if (! $detail = K::M('truste/truste')->detail($truste_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    $this->tmpl = 'afzn/member/truste/trusteDetail.html';
                }
    }
            ...
            if (! $detail = K::M('truste/truste')->detail($truste_id)) {
                ...
                if ($detail['uid'] != $this->uid) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->pagedata['detail'] = $detail;
                        $this->tmpl = 'afzn/member/truste/trusteEdit.html';
                    }
    }
                                ...
                                if (K::M('truste/look')->sign($look_id)) {
                                    switch ($member['from']) {
                                        ...
                                        case 'company':
                                            ...
                                            K::M('afzncompany/company')->update_count($this->company['company_id'], 'truste_sign');
                                        case 'shop':
                            ...
                            if (! $truste['sign_from']) {
                                ...
                                if ($truste['comment_id']) {
                                    ...
                                    if ($data = $this->checksubmit('data')) {
                                        ...
                                        $this->tmpl = 'afzn/member/truste/comments.html';
                                    }
    }
