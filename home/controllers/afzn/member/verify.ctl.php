...
// class Ctl_Afzn_Member_Verify extends Ctl_Afzn_Anfangzhineng
class Ctl_Afzn_Member_Verify extends Ctl
{
    ...
    public function name()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/member/verify/name.html';
        }
    }
    ...
    public function mobile($loc = null)
    {
        if ($loc == 'send') {
            ...
            if ($data = $this->checksubmit('data')) {
                ...
                $this->tmpl = 'afzn/member/verify/mobile.html';
            }
    }
    ...
    public function mail($loc = null)
    {
        if ($loc == 'verify') {
            ...
            $this->tmpl = 'afzn/member/verify/mail.html';
        }
    }
}