...
class Ctl_Afzn_Shop_Coupon extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'afzn/shop/coupon/items.html';
    }
                ...
                if ($allow_coupon < 0) {
                    ...
                    if (! $data = $this->check_fields($data, $this->_allow_fields)) {
                        ...
                        if ($coupon_id = K::M('shop/coupon')->create($data)) {
                            ...
                            $this->err->set_data('forward', $this->mklink('afzn/shop/coupon:index'));
                        }
                    }
            } else {
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'afzn/shop/coupon/create.html';
            }
    }
            ...
            if (! $detail = K::M('shop/coupon')->detail($coupon_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'afzn/shop/coupon/edit.html';
                    }
    }
    ...
    public function downloads($page = 1)
    {
        ...
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'afzn/shop/coupon/downloads.html';
    }
        ...
        if (! $download_id = (int) $download_id) {
            ...
            if (! $detail = K::M('shop/couponDownload')->detail($download_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'afzn/shop/coupon/downloadDetail.html';
                }
    }
