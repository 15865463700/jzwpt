...
class Ctl_Afzn_Shop_Vcate extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'afzn/shop/vcate/items.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/shop/vcate/create.html';
        }
    }
            ...
            if (! $detail = K::M('shop/vcate')->detail($vcat_id)) {
                ...
                if ($detail['shop_id'] != $shop['shop_id']) {
                    ...
                    if ($data = $this->checksubmit('data')) {
                        ...
                        $this->tmpl = 'afzn/shop/vcate/edit.html';
                    }
    }
