...
class Ctl_Afzn_Weixin_Addon_Lottery extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'afzn/weixin/addon/lottery/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/weixin/addon/lottery/create.html';
        }
    }
        ...
        if (! ($lottery_id = (int) $lottery_id) && ! ($lottery_id = $this->GP('lottery_id'))) {
            ...
            if (! $detail = K::M('weixin/lottery')->detail($lottery_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'afzn/weixin/addon/lottery/edit.html';
                }
    }
    ...
    public function sn($lottery_id, $page_id)
    {
        if (! ($lottery_id = (int) $lottery_id) && ! ($lottery_id = $this->GP('lottery_id'))) {
            ...
            if (! $detail = K::M('weixin/lottery')->detail($lottery_id)) {
                ...
                $this->tmpl = 'afzn/weixin/addon/lottery/sn.html';
            }
    }
