...
class Ctl_Afzn_Weixin_Addon_Scratch extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'afzn/weixin/addon/scratch/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/weixin/addon/scratch/create.html';
        }
    }
        ...
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'afzn/weixin/addon/scratch/edit.html';
                }
    }
    ...
    public function sn($scratch_id, $page_id)
    {
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                $this->tmpl = 'afzn/weixin/addon/scratch/sn.html';
            }
    }
    ...
    public function goods($scratch_id, $page_id)
    {
        ...
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                $this->pagedata['detail'] = $detail;
                $this->pagedata['pager'] = $pager;
                $this->tmpl = 'afzn/weixin/addon/scratch/goods.html';
            }
    }
        ...
        if (! ($scratch_id = (int) $scratch_id) && ! ($scratch_id = $this->GP('scratch_id'))) {
            ...
            if (! $detail = K::M('weixin/scratch')->detail($scratch_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'afzn/weixin/addon/scratch/goodscreate.html';
                }
    }
        ...
        if (! ($id = (int) $id) && ! ($id = $this->GP('id'))) {
            ...
            if (! $detail = K::M('weixin/prize')->detail($id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'afzn/weixin/addon/scratch/goodsedit.html';
                }
    }
