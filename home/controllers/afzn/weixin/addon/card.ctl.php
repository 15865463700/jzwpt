...
class Ctl_Afzn_Weixin_Addon_Card extends Ctl_Afzn_Anfangzhineng

{
    ...
    
    {
        ...
        if ($res['errcode'] == 0 && $res['total_num'] > 0) {
            ...
            $this->tmpl = 'afzn/weixin/addon/card/index.html';
        } else {
    ...
    
    {
        ...
        $qrurl = $this->mklink('afzn/weixin/addon/card:wxqrcode', array(), array(
            'id' => $id
        ));
    ...
    
    {
        ...
        $qrurl = $this->mklink('afzn/weixin/addon/card:wxqrcode2', array(), array(
            'codeurl' => $url
        ));
    ...
    
    {
        ...
        if ($code = $this->GP('code')) {
            ...
            $this->tmpl = 'afzn/weixin/addon/card/form.html';
        }
    }
    ...
    
    {
        ...
        $this->tmpl = 'afzn/weixin/addon/card/wxqrcode2.html';
    }
    ...
    
    {
        ...
        $this->tmpl = 'afzn/weixin/addon/card/wxqrcode.html';
    }
