...
class Ctl_Afzn_Weixin_Addon_Goldegg extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'afzn/weixin/addon/goldegg/index.html';
    }
    ...
    public function create()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/weixin/addon/goldegg/create.html';
        }
    }
        ...
        if (! ($goldegg_id = (int) $goldegg_id) && ! ($goldegg_id = $this->GP('goldegg_id'))) {
            ...
            if (! $detail = K::M('weixin/goldegg')->detail($goldegg_id)) {
                ...
                if ($data = $this->checksubmit('data')) {
                    ...
                    $this->tmpl = 'afzn/weixin/addon/goldegg/edit.html';
                }
    }
    ...
    public function sn($goldegg_id, $page_id)
    {
        if (! ($goldegg_id = (int) $goldegg_id) && ! ($goldegg_id = $this->GP('goldegg_id'))) {
            ...
            if (! $detail = K::M('weixin/goldegg')->detail($goldegg_id)) {
                ...
                $this->tmpl = 'afzn/weixin/addon/goldegg/sn.html';
            }
    }
