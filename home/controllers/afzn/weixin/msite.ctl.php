...
class Ctl_Afzn_Weixin_Msite extends Ctl_Afzn_Anfangzhineng
{
    ...
    {
        $this->tmpl = 'afzn/weixin/msite/access.html';
    }
    ...
    public function index()
    {
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/weixin/msite/index.html';
        }
    }
    ...
    public function tmpl($from = 'index')
    {
        ...
        if ($tmpl = $this->checksubmit('template')) {
            ...
            $this->tmpl = 'afzn/weixin/msite/tmpl.html';
        }
    }
