...
// class Ctl_Afzn_Company_Zxpm extends Ctl_Afzn_Anfangzhineng
class Ctl_Afzn_Company_Zxpm extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        // }
        $this->tmpl = 'afzn/company/zxpm/items.html';
    }
    ...
    public function detail($site_id = null)
    {
        ...
        if (! $site_id) {
            ...
            $this->tmpl = 'afzn/company/zxpm/detail.html';
        }
    }
