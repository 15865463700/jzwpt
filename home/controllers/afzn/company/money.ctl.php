...
// class Ctl_Afzn_Company_Money extends Ctl_Afzn_Anfangzhineng
class Ctl_Afzn_Company_Money extends Ctl
{
    ...
    public function company($type = 'all', $page = 1)
    {
        ...
        $this->tmpl = 'afzn/company/money/items.html';
    }
    ...
    public function tixian()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/company/money/tixian.html';
        }
    }
}