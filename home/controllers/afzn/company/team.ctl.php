...
// class Ctl_Afzn_Company_Team extends Ctl_Afzn_Anfangzhineng
class Ctl_Afzn_Company_Team extends Ctl
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'afzn/company/team/items.html';
    }
    ...
    public function bind()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'afzn/company/team/bind.html';
        }
    }
