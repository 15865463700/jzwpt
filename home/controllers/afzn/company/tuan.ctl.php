...
// class Ctl_Afzn_Company_Tuan extends Ctl_Afzn_Anfangzhineng
class Ctl_Afzn_Company_Tuan extends Ctl
{
    ...
    public function index($page)
    {
        ...
        $this->tmpl = 'afzn/company/tuan/items.html';
        // }
    }
    ...
    public function sign($tuan_id, $page)
    {
        ...
        if (! $tuan_id = (int) $tuan_id) {
            ...
            if (! $tuan = K::M('home/tuan')->detail($tuan_id)) {
                ...
                $this->tmpl = 'afzn/company/tuan/sign.html';
            }
    }
}