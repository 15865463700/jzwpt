...
class Ctl_Afzn_Company_Yuyue extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function company($page = 1)
    {
        ...
        $this->tmpl = 'afzn/company/yuyue/items.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('afzncompany/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->tmpl = 'afzn/company/yuyue/detail.html';
                }
    }
    ...
    public function designer($page = 1)
    {
        ...
        $this->tmpl = 'afzn/company/yuyue/designer.html';
    }
        ...
        if (! $yuyue_id = (int) $yuyue_id) {
            ...
            if (! $detail = K::M('designer/yuyue')->detail($yuyue_id)) {
                ...
                if ($detail['company_id'] != $company['company_id']) {
                    ...
                    $this->pagedata['detail'] = $detail;
                    $this->tmpl = 'afzn/company/yuyue/designerDetail.html';
                }
    }
