...
class Ctl_Afzn_Shop extends Ctl_Afzn_Anfangzhineng
{
    ...
    public function index()
    {
        ...
        $this->tmpl = 'afzn/shop/index.html';
    }
    ...
    public function domain()
    {
        ...
        if (! $CFG['domain']['shop']) {
            ...
            if ($domain = $this->checksubmit('domain')) {
                if ($shop['group']['priv']['allow_domain'] < 0) {
                    ...
                    if ($shop['domain']) {
                        ...
                        if ($CFG['domain']['company'] == $CFG['domain']['shop']) { // 当与公司公司设置相同时判断公司是否占用了
                            if ($company = K::M('afzncompany/company')->company_by_domain($domain)) {
                ...
                $this->tmpl = 'afzn/shop/domain.html';
            }
    }
    ...
    public function refresh()
    {
        ...
        if ($this->GP('fromid')) {
            ...
            $this->tmpl = 'afzn/shop/refresh/look.html';
        }
    }
