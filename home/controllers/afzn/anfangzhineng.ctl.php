 ...
 * Class Ctl_Afzn
 */
class Ctl_Afzn_Anfangzhineng extends Ctl
{
    ...
    // // $this->company = K::M('afzncompany/company')->company_by_uid($this->MEMBER['uid']);
    // // }
    // //
    ...
    // {
    // if($this->MEMBER['from'] != 'company'){
    // $this->err->add('您的帐号不是安防智能公司类型', 211);
    // $this->response();
    // }else if($this->company = K::M('afzncompany/company')->company_by_uid($this->uid)){
    ...
    // return $this->company;
    // }else if($this->request['ctl'] == 'afzn/company' && $this->request['act'] == 'info'){
    ...
    // return $this->shop;
    // }else if($this->request['ctl'] == 'afzn/shop' && $this->request['act'] == 'info'){
    ...
    // $this->tmpl = 'afzn/passport/login.html';
    // }
    // $this->err->response();
    // exit();
    // }
