...
class Ctl_Mall_Shop extends Ctl
{
    ...
    public function news($shop_id, $page = 1)
    {
        ...
        if ($items = K::M('shop/news')->items_by_shop($shop_id, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('mall/shop:news', array(
                $shop_id,
                '{page}'
            ), array(
                'shop' => $shop
    ...
    public function mendian($shop_id, $page = 1)
    {
        ...
        if ($items = K::M('shop/mendian')->items_by_shop($shop_id, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('mall/shop:mendian', array(
                $shop_id,
                '{page}'
            ), array(
                'shop' => $shop
    ...
    public function product($shop_id, $vcat_id = 0, $page = null)
    {
        ...
        if ($items = K::M('product/product')->items($filter, null, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('mall/shop:product', array(
                $shop_id,
                $vcat_id,
                '{page}'
            ), array(
