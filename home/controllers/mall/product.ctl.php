...
class Ctl_Mall_Product extends Ctl
{
    ...
    public function index()
    {
        ...
        if ($items = K::M('product/product')->items($filter, $orderby, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('mall/product', array(
                $cat_id,
                $attr_ids,
                $order,
                '{page}'
        ...
        $order_link = array();
        $order_link['default'] = $this->mklink('mall/product', array(
            $cat_id,
            $brand_id,
            $attr_ids,
            0,
        ...
        $order_link['buy'] = $this->mklink('mall/product', array(
            $cat_id,
            $brand_id,
            $attr_ids,
            1,
        ...
        $order_link['price'] = $this->mklink('mall/product', array(
            $cat_id,
            $brand_id,
            $attr_ids,
            2,
