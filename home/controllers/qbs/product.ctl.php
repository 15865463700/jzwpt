...
class Ctl_Qbs_Product extends Ctl
{
    ...
    public function index()
    {
        ...
        if ($items = K::M('product/product')->items($filter, $orderby, $page, $limit, $count)) {
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('qbs/product', array(
                $cat_id,
                $attr_ids,
                $order,
                '{page}'
        ...
        $order_link = array();
        $order_link['default'] = $this->mklink('qbs/product', array(
            $cat_id,
            $brand_id,
            $attr_ids,
            0,
        ...
        $order_link['buy'] = $this->mklink('qbs/product', array(
            $cat_id,
            $brand_id,
            $attr_ids,
            1,
        ...
        $order_link['price'] = $this->mklink('qbs/product', array(
            $cat_id,
            $brand_id,
            $attr_ids,
            2,
        ...
        $this->tmpl = 'qbs/product/items.html';
    }
            ...
            if (! $detail = K::M('product/product')->detail($product_id)) {
                ...
                if (empty($detail['audit'])) {
                    ...
                    if ($shop = $this->check_shop($detail['shop_id'])) {
                        ...
                        $this->tmpl = 'qbs/product/detail.html';
                    }
    }
