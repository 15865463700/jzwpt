...
class Ctl_Dcenter_Gz extends Ctl_Dcenter
{
    ...
    public function refresh()
    {
        ...
        if ($this->GP('fromid')) {
            ...
            $this->tmpl = 'dcenter/gz/refresh/look.html';
        }
    }
        ...
        if ($data = $this->checksubmit('data')) {
            if (! $data = $this->check_fields($data, $this->_allow_fields)) {
                ...
                if (! $gz['gz_id']) {
                    ...
                    K::M('member/member')->update($gz['uid'], array(
    ...
    public function attr()
    {
        ...
        if ($attr = $this->checksubmit('attr')) {
            ...
            $this->tmpl = 'dcenter/gz/attr.html';
        }
    }
}