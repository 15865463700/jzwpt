 ...
 * $Id$
 */
class Ctl_Dcenter_Member_Verify extends Ctl_Dcenter
{
    ...
    public function name()
    {
        ...
        if ($data = $this->checksubmit('data')) {
            ...
            $this->tmpl = 'dcenter/member/verify/name.html';
        }
    }
    ...
    public function mobile($loc = null)
    {
        if ($loc == 'send') {
            ...
            if ($data = $this->checksubmit('data')) {
                ...
                $this->tmpl = 'dcenter/member/verify/mobile.html';
            }
    }
    ...
    public function mail($loc = null)
    {
        if ($loc == 'verify') {
            ...
            $this->tmpl = 'dcenter/member/verify/mail.html';
        }
    }
}