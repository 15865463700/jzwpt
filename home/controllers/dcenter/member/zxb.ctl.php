 ...
 * $Id$
 */
class Ctl_Dcenter_Member_Zxb extends Ctl_Dcenter
{
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'dcenter/member/zxb/items.html';
    }
    ...
    public function lists($zxb_id)
    {
        ...
        if (! $detail = K::M('zxb/zxb')->detail($zxb_id)) {
            ...
            $this->tmpl = 'dcenter/member/zxb/lists.html';
        }
    }
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if (! $member = K::M('member/member')->detail($this->uid)) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->tmpl = 'dcenter/member/zxb/hetong.html';
                            }
                        }
    }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'dcenter/member/zxb/detail.html';
                        }
                    }
    }
                ...
                if ($this->uid != $detail['uid']) {
                    ...
                    if ($detail['status'] < ($status - 1)) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->pagedata['now_status'] = $status;
                            $this->tmpl = 'dcenter/member/zxb/endstep.html';
                        }
                    }
    }
                ...
                if (! $detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if ($this->checksubmit('data')) {
                            ...
                            $this->tmpl = 'dcenter/member/zxb/look.html';
                        }
                    }
    }
                ...
                if (! $detail['company_id']) {
                    ...
                    if (empty($detail['audit'])) {
                        ...
                        if (! $plaint = K::M('zxb/plaint')->items(array(
                            ...
                            $this->tmpl = 'dcenter/member/zxb/plaint.html';
                        }
    }
                    ...
                    if (! $detail['company_id']) {
                        ...
                        if (empty($detail['audit'])) {
                            ...
                            if ($this->checksubmit('data')) {
                                ...
                                $this->pagedata['zxb_id'] = $zxb_id;
                                $this->pagedata['plaint'] = $plaint;
                                $this->tmpl = 'dcenter/member/zxb/plaintedit.html';
                            }
                        }
    }
}