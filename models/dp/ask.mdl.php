...
class Mdl_Dp_Ask extends Mdl_Table
{   
  
    protected $_table = 'dp';
    protected $_pk = 'ask_id';
    protected $_cols = 'ask_id,title,seo_title,seo_keyword,thumb,seo_description,cat_id,uid,intro,dateline,clientip,views,answer_num,audit,answer_id,orderby,prop,thumb_up';
