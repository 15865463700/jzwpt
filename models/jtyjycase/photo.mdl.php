...
class Mdl_Jtyjycase_Photo extends Mdl_Table
{   
  
    protected $_table = 'jtyjy_case_photo';
    protected $_pk = 'photo_id';
    protected $_cols = 'photo_id,city_id,case_id,title,photo,size,views,orderby,closed,clientip,dateline';
