...
class Mdl_Ruanzhuangpeishi_Ruanzhuangpeishi extends Mdl_Table
{
  
    protected $_table = 'rzps';
    protected $_pk = 'rzps_id';
    protected $_cols = 'rzps_id,rzps_title,add_time,rzps_thumb,rzps_user_id,rzps_user_name,rzps_user_img,rzps_video,info,detail,lianxiren,phone,mobile,qq,address';
    protected $_orderby = array('rzps_id'=>'DESC');
