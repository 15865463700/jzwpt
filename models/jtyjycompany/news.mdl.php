 ...
 * $Id: news.mdl.php 5425 2014-06-05 11:33:31Z youyi $
 */
...
class Mdl_Jtyjycompany_News extends Mdl_Table
{   
  
    protected $_table = 'jtyjy_company_news';
    ...
    public function news_count($val)
    {
        ...
        if($rs = $this->db->Execute($sql)){
            ...
            foreach($counts as $k=>$v){
                K::M('rzpscompany/company')->update($k, array('news_num'=>$v), true);
                $count ++;
            }            
        }
        return $count;
