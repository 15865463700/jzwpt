...
{   
    ...
    protected $_cols = 'cat_id,parent_id,title,py,level,from,seo_title,seo_keywords,seo_description,orderby,hidden,dateline';
    ...
    public function cat_root($cat_id){
        for($i=0;$i<10;$i++){
            $cat=$this->cate($cat_id);
