...
{   
    ...
    protected $_cols = 'diary_id,uid,title,home_id,home_name,city_id,thumb,company_id,type_id,way_id,total_price,start_date,end_date,content_num,views,comments,status,clientip,dateline,audit,closed,meter,ctitle';
