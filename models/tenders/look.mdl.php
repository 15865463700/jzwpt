...
{   
    ...
    protected $_cols = 'look_id,tenders_id,uid,content,clientip,dateline,is_signed,city_id,from,company_id,info,see';
	...
	public function looks_count($from=null,$oid=0,$status=0){
        return $this->count("company_id='{$oid}' and see=0 and is_signed=0");
	}
