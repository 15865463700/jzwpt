...
class Ctl_Zxb_Gz extends Ctl{
    public function detail($zxb_id = null){
        if(!$zxb_id = (int)$zxb_id){
            ...
            $this->tmpl = 'admin:zxb/gz/detail.html';
        }
    }
    public function create(){
        if($data = $this->checksubmit('data')){
           ...
           $this->tmpl = 'admin:zxb/gz/create.html';
        }
    }
	...
	public function dialog($page=1)
    {
        ...
        $this->tmpl = 'admin:zxb/gz/dialog.html';   
    }
    ...
    public function edit($zxb_id=null)
    {
        if(!($zxb_id = (int)$zxb_id) && !($zxb_id = $this->GP('zxb_id'))){
        	...
        	$this->pagedata['detail'] = $detail;
        	$this->tmpl = 'admin:zxb/gz/edit.html';
        }
    }
