 ...
 * $Id: role.ctl.php 2034 2013-12-07 03:08:33Z $
 */
...
class Ctl_Fenzhan_Role extends Ctl
{
	...
	public function index()
	{
		...
		$this->tmpl = 'fenzhan:admin/role/index.html';
	}
	...
	public function create()
	{
		...
		$this->tmpl = 'fenzhan:admin/role/detail.html';
	}
	...
	public function detail($ID)
	{
		if(!$ID = intval($ID)){
			...
			$this->pagedata['menu_tree'] = K::M('fenzhan/auth')->fenzhan_tree();
//			var_dump(K::M('fenzhan/auth')->fenzhan_tree());
