...
class Ctl_Case_Comment extends Ctl {
    ...
    public function index($page = 1)
    {
        ...
        $this->tmpl = 'fenzhan:case/comment/items.html';
    }

    public function so()
    {
        $this->tmpl = 'fenzhan:case/comment/so.html';
    }
    ...
    public function edit($comment_id = null)
    {
        if (!($comment_id = (int) $comment_id) && !($comment_id = $this->GP('comment_id'))) {
			...
			#vdp($detail);echo "File:", __FILE__, ',Line:',__LINE__;exit;
            $this->tmpl = 'fenzhan:case/comment/edit.html';
        }
    }
